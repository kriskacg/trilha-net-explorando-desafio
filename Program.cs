...
Pessoa p1 = new Pessoa(nome: "Ana Maria", sobrenome: "Pereira da Silva");
Pessoa p2 = new Pessoa(nome: "José Antonio", sobrenome: "da Silva");
Pessoa p3 = new Pessoa(nome: "Madalena", sobrenome: "Pereira da Silva" );
